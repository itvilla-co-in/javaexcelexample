        ...
        <section class="iq-blog overview-block-ptb">
            <div class="container">
                <div class="row">
                    ...
                    <!--  now this is divided into two columsn based on the device  -->
                            ...
                            <div class="col-lg-6 col-sm-12">
                                ...
                                <div class="iq-blog-entry white-bg">
                                    <div class="iq-entry-image clearfix">
                                        <img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/blog/01.jpg" alt="#">
                                ...
                                <div class="iq-blog-entry white-bg iq-mt-30">
                                    <div class="iq-entry-image clearfix">
                                        <div class="owl-carousel arrow-1" data-nav-dots="false" data-nav-arrow="true" data-items="1" data-xs-items="1" data-sm-items="1" data-md-items="1" data-lg-items="1" data-autoplay="true">
                                            <div class="item">
                                                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/blog/02.jpg" alt="#">
                                            </div>
                                            <div class="item">
                                                <img class="img-fluid" src="${pageContext.request.contextPath}/resources/images/blog/03.jpg" alt="#">
                                            </div>
                                        </div>
                                        <span class="tag"><i class="ion-image"></i> Photos</span>
                                        <span class="date">12<small>Aug</small></span>
                             ...
                             <!-- Second column of blog grid  on right  -->
