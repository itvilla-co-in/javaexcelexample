                    ...
                    <div class="row">
                        <div class="col-lg-12 col-md-12">
                            <div class="heading-title text-center">
                                <h2 class="title iq-tw-6 iq-font-white">Add Employee</h2>
                    ...
                    <div class="row justify-content-md-center">
                        <div class="col-sm-8">
                            ...
                            <div class="iq-register no-brd iq-pt-40 iq-pb-30 iq-plr-30">
                                ...
                                <form:form action="${pageContext.request.contextPath}/admin/emp/saveEmployee" modelAttribute="employee" method="POST">
									...
									<div class="form-group">
                                        <label>empId</label>
                                        <form:input path="empId" class="form-control" id="empaddempId" placeholder="Employee Id"/>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <form:input path="firstName" class="form-control" id="empaddfirstname" placeholder="FirstName"/>
                                        <form:errors path="firstName" cssStyle="color: red;"/>
                                    </div>
                                    
                                    <div class="form-group">
                                        <label>LastName</label>
                                        <form:input path="lastName" class="form-control" id="empaddlastname" placeholder="LastName"/>
									...
									<div class="form-group">
                                    <label>DOB</label>
                                        <form:input path="empDob" class="form-control" id="datepicker-13" placeholder="DOB"/>
                                         <form:errors path="empDob" cssStyle="color: red;"/>
                                    </div>
                                    
                                                                        <div class="form-group">
                                        <label>empProfileimg</label>
                                        <form:input path="empProfileimg" class="form-control" id="empaddempProfileimg" placeholder="empProfileimg"/>
                                        <form:errors path="empProfileimg" cssStyle="color: red;"/>
                                    </div>
									
									<div class="form-group">
                                        <label>empBand</label>
                                        <form:input path="empBand" class="form-control" id="empaddempBand" placeholder="Band"/>
                                        <form:errors path="empBand" cssStyle="color: red;"/>
                                    </div>
									
								    <div class="form-group">
                                        <label>empLoc</label>
                                        <form:input path="empLoc" class="form-control" id="empaddempLoc" placeholder="Location"/>
                                        <form:errors path="empLoc" cssStyle="color: red;"/>
                                    </div>
									
									<div class="form-group">
                                        <label>empLoccode</label>
                                        <form:input path="empLoccode" class="form-control" id="empaddempLoccode" placeholder="Location Code"/>
                                        <form:errors path="empLoccode" cssStyle="color: red;"/>
                                    </div>
